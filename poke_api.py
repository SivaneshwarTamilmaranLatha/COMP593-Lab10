...
def main():
    ...
    download_pokemon_artwork('dugtrio', r'C:\Users\sivan\OneDrive\Documents\GitHub\COMP593-Lab10')
    return
...
def get_pokemon_image_url(pokemon_name):
    """Gets the URL of the official artwork for a specified Pokemon from the PokeAPI.

    Args:
        pokemon_name (str): The name of the Pokemon.

    Returns:
        str: URL of the official artwork, if successful. Otherwise None.
    """
    poke_info = get_pokemon_info(pokemon_name)
    if poke_info:
        return poke_info['sprites']['other']['official-artwork']['front_default']
    return None
